export CARLA_ROOT=${1:-/home/tijp4b/Downloads/transfuser/CARLA_0.9.10.1}
export WORK_DIR=${2:-//home/tijp4b/Downloads/transfuser}
...
export PYTHONPATH=$PYTHONPATH:$/home/tijp4b/Downloads/transfuser/leaderboard/leaderboard
